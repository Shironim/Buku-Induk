    ...
    <section class="content">
      <div class="row">
        <div class="col-lg-12">
          ...
          $dataapa = "Rombongan Belajar"; // data
              ...
              <div class="box-body">
                <div class="table-responsive">
                  ...
                  if ($_SESSION['jabatan'] == 'admin') {
                    ...
                    $sql = "SELECT * FROM rombel WHERE id_rombel = '$id_rombel'";
                  ...
                  <div id="main">
                    <div class="container-fluid">
                        ...
                        <div class="box-body">
                          <div class="row">
                            <div class="form-group col-md-6 col-xs-12">
                              <label for="rombel" class="col-sm-3 control-label">Tahun Ajaran :</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" id="rombel" name="rombel" value="<?php echo $fill['rombel']; ?>" placeholder="Masukan Rombel" maxlength="50">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      if (isset($_POST['simpan'])) {
                        $rombel = $_POST['rombel'];
                        $sql = "UPDATE rombel SET rombel = '$rombel' WHERE id_rombel = '$id_rombel'";

                        $run_sql = mysqli_query($conn, $sql);

                        if ($run_sql) {
                          echo "<script>alert('Update Berhasil');location.href='kelas_rombel'</script>";
                        }
                      }
                      ?>
                    </div>
