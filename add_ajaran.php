                ...
                <div class="table-responsive">
                  ...
                  <div id="main">
                        ...
                        <div class="box-body">
                          ...
                          <div class="row">
                            <div class="form-group col-md-6 col-xs-12">
                              ...
                              <div class="col-sm-9">
                                <input type="text" class="form-control" id="tahun_ajaran" name="tahun_ajaran" value="<?php echo $nama; ?>" placeholder="Masukan Tahun Ajaran" maxlength="50">
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    if (isset($_POST['simpan'])) {
                      ...
                      if ($result) {
                        echo "<script>alert('Tambah Berhasil');location.href='tahun_ajaran'</script>";
                      }
                    }
