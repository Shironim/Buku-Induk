                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-lg-12">
                              ...
                              <div class="row">
                                <div class="form-group col-md-6 col-xs-12">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nomor_kip" name="nomor_kip" value="<?php echo $nomor_kip; ?>">
                                  </div>
                                </div>
                              </div>
                              <div class="box-footer">
                                ...
                                <a href="tambah_kps_siswa">
                                  <button type="button" class="ml-3 btn btn-info pull-left btn-flat" name="simpan"> Tidak ada data KIP <span class="glyphicon glyphicon-arrow-right"></span></button>
                                </a>
                              </div>
                            </div>
                          </div>
                      ...
                      if (isset($_POST['simpan'])) {
                        ...
                        WHERE id_siswa = '$id_siswa'";
                          ...
                          if ($run_sql) {
                            echo "<script>alert('Berhasil tambah data');location.href='tambah_kps_siswa'</script>";
                          } else {
                            echo "<script>
                          alert('gagal')
                          </script>";
