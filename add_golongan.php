    ...
    <section class="content">
      <div class="row">
        <div class="col-lg-12">
          ...
          $halaman = "golongan"; // halaman
          $dataapa = "Golongan"; // data
          $tabeldatabase = "golongan"; // tabel database
                        ...
                        <div class="box-body">
                          ...
                          <div class="row">
                            <div class="form-group col-md-6 col-xs-12">
                              ...
                              <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Nama Golongan" maxlength="50">
                              </div>
                            </div>
                          </div>
