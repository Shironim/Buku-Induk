                    ...
                    <div class="container-fluid">
                              ...
                              <div class="row">
                                ...
                                if (isset($fetch)) { ?>
                                  <div class="alert alert-info" role="alert">
                                    ...
                                    Data Pendidikan Siswa Ditemukan
                                  </div>
                                <?php } else { ?>
                                  <div class="alert alert-danger" role="alert">
                                    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                                    <span class="sr-only">Error:</span>
                                    Data Pendidikan Siswa Tidak Ditemukan
                                  </div>
                                <?php } ?>
                              </div>
                            </div>
                            <div class="col-lg-12">
                              ...
                              <div class="row">
                                <div class="form-group col-md-6 col-xs-12">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="sekolahasal" name="sekolahasal" value="<?php echo $fetch['sekolah_asal']; ?>">
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="form-group col-md-6 col-xs-12">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="noskhun" name="noskhun" value="<?php echo $fetch['skhun']; ?>">
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="form-group col-md-6 col-xs-12">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control pull-right" name="no_ujian_nasional" value="<?php echo $fetch['no_ujian_nasional']; ?>">
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="form-group col-md-6 col-xs-12">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="noijazah" name="noijazah" value="<?php echo $fetch['no_seri_ijasah']; ?>">
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                  ...
                                  <div class="col-sm-9">
                                    ...
                                    <select class="form-control " style="width: 100%;" name="tahun_ajaran" id="tahun_ajaran">
                                      ...
                                      while ($data = mysqli_fetch_array($run_tahun_ajaran)) { ?>
                                        <?php if ($data['id_tahun_ajaran'] == $fetch['id_tahun_ajaran']) { ?>
                                          <option selected value='<?= $data['id_tahun_ajaran'] ?>'><?= $data['tahun_ajaran'] ?></option>
                                        <?php } else { ?>
                              ...
                              <div class="box-footer">
                                ...
                                if (isset($fetch)) { ?>
                                  ...
                                  <a href="edit_bank?id=<?= $get_id_siswa ?>">
                                    <button type="button" class="ml-3 btn btn-info pull-left btn-flat" name="simpan"> Edit Data Bank <span class="glyphicon glyphicon-arrow-right"></span></button>
                                  </a>
                                <?php } else { ?>
                                  <button type="submit" class="ml-3 btn btn-info pull-left btn-flat" name="tambah"> Tambah Data Pendidikan <span class="glyphicon glyphicon-plus"></span></button>
                                  <a href="edit_bank?id=<?= $get_id_siswa ?>">
                                    <button type="button" class="ml-3 btn btn-info pull-left btn-flat"> Tidak ada Data Pendidikan <span class="glyphicon glyphicon-arrow-right"></span></button>
                                  </a>
                                <?php } ?>
                      ...
                      if (isset($_POST['simpan']) || isset($_POST['tambah'])) {
                        ...
                        ";
                          ...
                          if ($run_sql) {
                            echo "<script>
                                alert('Berhasil');location.href='edit_bank?id=$get_id_siswa'
                              </script>";
                          } else {
                            echo "<script>
                                alert('gagal')
