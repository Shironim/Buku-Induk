    ...
    <section class="content">
      <div class="row">
        <div class="col-lg-12">
          ...
          $halaman = "status"; // halaman
          $dataapa = "Status Siswa"; // data
          $tabeldatabase = "status"; // tabel database
                        ...
                        <div class="box-body">
                          ...
                          <div class="row">
                            <div class="form-group col-md-6 col-xs-12">
                              ...
                              <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Nama Status Siswa" maxlength="50">
                              </div>
                            </div>
                          </div>
