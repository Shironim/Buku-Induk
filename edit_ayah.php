    ...
    <section class="content">
      <div class="row">
        <div class="col-lg-12">
          ...
          $sql = "SELECT *, siswa.id_siswa, siswa.nama_siswa FROM ayah_siswa JOIN siswa ON ayah_siswa.id_siswa = siswa.id_siswa WHERE ayah_siswa.id_siswa = '$get_id_siswa'";
          $data = mysqli_query($conn, $sql);
          $fetch = mysqli_fetch_array($data);
          $sql_ayah = "SELECT * FROM ayah_siswa WHERE id_siswa = '$get_id_siswa'";
          $data_ayah = mysqli_query($conn, $sql_ayah);
          $fetch_ayah = mysqli_fetch_array($data_ayah);
          ...
          ?>
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title">Tambah Data Ayah Siswa <?= $fetch['nama_siswa'] ?></h3>
              </div>
              <!-- /.box-header -->
                  ...
                  <div id="main">
                    <div class="container-fluid">
                      <form class="form-horizontal" method="post" action="" id="Myform">
                        <div class="nav-tabs-custom">
                          <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab">Data Ayah</a></li>
                          </ul>
                        </div>
                              ...
                              <div class="row">
                                ...
                                if (isset($fetch_ayah)) { ?>
                                  <div class="alert alert-info" role="alert">
                                    ...
                                    Data Ayah Siswa Ditemukan
                                  </div>
                                <?php } else { ?>
                                  <div class="alert alert-danger" role="alert">
                                    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                                    <span class="sr-only">Error:</span>
                                    Data Ayah Siswa Tidak Ditemukan
                                  </div>
                                <?php } ?>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="row">
                                <div class="form-group col-md-12 col-xs-12">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nama_ayah" name="nama_ayah" value="<?php echo $fetch['nama_ayah']; ?>">
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="form-group col-md-12 col-xs-12">
                                  ...
                                  <div class="col-sm-6">
                                    <input type="text" class="form-control" id="tahun_lahir_ayah" name="tahun_lahir_ayah" value="<?php echo $fetch['tahun_lahir_ayah']; ?>">
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="form-group col-md-12 col-xs-12">
                                  ...
                                  <div class="col-sm-9">
                                    <?php
                                    $jenjang = $fetch_ayah['jenjang_pendidikan_ayah'];
                                    ...
                                    ?>
                                    <select class="form-control " style="width: 100%;" name="pendidikanterakhirayah" id="pendidikanterakhirayah">
                                      <option value=''></option>
                              ...
                              <div class="row">
                                <div class="form-group col-md-12 col-xs-12">
                                  ...
                                  <div class="col-sm-9">
                                    <?php
                                    $pekerjaan = $fetch_ayah['pekerjaan_ayah'];
                                    ...
                                    ?>
                                    <select class="form-control " style="width: 100%;" name="pekerjaanayah" id="pekerjaanayah">
                                      <option value=''></option>
                              ...
                              <div class="row">
                                <div class="form-group col-md-12 col-xs-12">
                                  ...
                                  <div class="col-sm-9">
                                    <?php
                                    $penghasilan = $fetch_ayah['penghasilan_ayah'];
                                    ...
                                    ?>
                                    <select class="form-control " style="width: 100%;" name="penghasilanayah" id="penghasilanayah">
                                      <option value=''></option>
                              ...
                              <div class="row">
                                <div class="form-group col-md-12 col-xs-12">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nik_ayah" name="nik_ayah" value="<?php echo $fetch_ayah['nik_ayah']; ?>">
                                  </div>
                                </div>
                              </div>
                              <div class="box-footer">
                                ...
                                if (isset($fetch_ayah)) { ?>
                                  ...
                                  <a href="edit_ibu?id=<?= $get_id_siswa ?>">
                                    <button type="button" class="ml-3 btn btn-info pull-left btn-flat"> Edit Data Ibu <span class="glyphicon glyphicon-arrow-right"></span></button>
                                  </a>
                                <?php } else { ?>
                                  <button type="submit" name="tambah" class="ml-3 btn btn-info pull-left btn-flat"> Tambah Data Ayah <span class="glyphicon glyphicon-plus"></span></button>
                                  <a href="edit_ibu?id=<?= $get_id_siswa ?>">
                                    <button type="button" class="ml-3 btn btn-info pull-left btn-flat"> Tidak ada data Ayah <span class="glyphicon glyphicon-arrow-right"></span></button>
                                  </a>
                                <?php } ?>
                      ...
                      if (isset($_POST['tambah'])) {
                        if (empty($nama_ayah)) {
                          echo "<script>alert('Nama Ayah Siswa Tidak Boleh Kosong')</script>";
                        } else {
                          $sql = "INSERT INTO ayah_siswa (id_siswa, nama_ayah,pekerjaan_ayah,penghasilan_ayah, jenjang_pendidikan_ayah, tahun_lahir_ayah, nik_ayah) VALUES ('$id_siswa','$nama_ayah','$pekerjaanayah','$penghasilanayah','$pendidikanterakhirayah','$tahun_lahir_ayah','$nik_ayah')";

                          $run_sql = mysqli_query($conn, $sql);

                          if ($run_sql) {
                            echo "<script>alert('Berhasil Tambah Data Ayah Siswa');location.href='edit_ibu?id=$get_id_siswa'</script>";
                          } else {
                            echo "<script>
                                alert('gagal')
                              </script>";
                      ...
                      if (isset($_POST['simpan'])) {
                        if (empty($nama_ayah)) {
                          ...
                          $sql = "UPDATE ayah_siswa SET 
                        nama_ayah = '$nama_ayah',
                        pekerjaan_ayah = '$pekerjaanayah',
                        penghasilan_ayah = '$penghasilanayah', 
                        jenjang_pendidikan_ayah = '$pendidikanterakhirayah', 
                        ...
                        WHERE id_siswa ='$get_id_siswa'";
                          ...
                          if ($run_sql) {
                            echo "<script>
                                alert('berhasil');location.href='edit_ibu?id=$get_id_siswa'
                              </script>";
                          } else {
                            echo "<script>
                                alert('gagal')
